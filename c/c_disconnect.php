...
<?php
    ...
    else
    {
   	...
   	function error()
	{
		print "SMOAD Daemon is down or disconnected or may be the Daemon port is protected access by a Firewall.<br>Kindly debug the same and re-connect again ! <br><br>";
