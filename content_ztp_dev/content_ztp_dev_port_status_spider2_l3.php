<?php
	...
	$query = "select lan_cable_status, wan_cable_status, wan2_cable_status, wan3_cable_status, sdwan_cable_status,
					wan_link_status, wan2_link_status, wan3_link_status, sdwan_link_status, lte1_link_status, lte2_link_status, lte3_link_status,  
					wan_latency, wan2_latency, wan3_latency, sdwan_latency, lte1_latency, lte2_latency, lte3_latency, 
					wan_jitter, wan2_jitter, wan3_jitter, sdwan_jitter, lte1_jitter, lte2_jitter, lte3_jitter    
	...
	{	while($row = $res->fetch_assoc())
		{	$lan_cable_status = get_port_cable_status_icon($row['lan_cable_status']);
			...
			$wan3_cable_status = get_port_cable_status_icon($row['wan3_cable_status']);
			
			$wan_link_status = get_link_status_icon($row['wan_link_status']);
			$wan2_link_status = get_link_status_icon($row['wan2_link_status']);
			$wan3_link_status = get_link_status_icon($row['wan3_link_status']);
			...
			$lte3_link_status = get_link_status_icon($row['lte3_link_status']);
			
			$wan_latency = get_link_latency($row['wan_latency']);
			$wan2_latency = get_link_latency($row['wan2_latency']);
			$wan3_latency = get_link_latency($row['wan3_latency']);
			...
			$lte3_latency = get_link_latency($row['lte3_latency']);
			
			$wan_jitter = get_link_jitter($row['wan_jitter']);
			$wan2_jitter = get_link_jitter($row['wan2_jitter']);
			$wan3_jitter = get_link_jitter($row['wan3_jitter']);
			...
			$lte3_jitter = get_link_jitter($row['lte3_jitter']);
		}
	}
	...
	$link_status_wan3_up_count = get_last_24_port_up_count($db, $G_device_serialnumber, "link_status_wan3_up_count");
	...
	$link_status_lte3_up_count = get_last_24_port_up_count($db, $G_device_serialnumber, "link_status_lte3_up_count");
	...
	$link_status_wan3_up_count_timestamp = get_last_port_up_count_timestamp($db, $G_device_serialnumber, "link_status_wan3_up_count");
	...
	$link_status_lte3_up_count_timestamp = get_last_port_up_count_timestamp($db, $G_device_serialnumber, "link_status_lte3_up_count");
	...
	print '<table class="list_items" style="width:720px;text-align:center;">';
	print "<tr><td align=left>H/w Status</td>
				...
				<td style=\"width:80px;\"><a title=\"Configure WAN3 port ?\" href=\"index.php?page=ztp_dev_wan&wanport=wan3&skey=$session_key\" >$wan3_cable_status</a></td>
            ...
            <td style=\"width:80px;\"><a title=\"Configure LTE3 port ?\" href=\"index.php?page=ztplte&lteport=lte3&skey=$_session_key\" ><img src=\"i/lte.png\" style=\"width:20px;height:20px;\" /></a></td>
				</tr>";
	print "<tr><td></td><td>SD-WAN</td><td>WAN</td><td>WAN2</td><td>WAN3</td><td>LAN</td><td>LTE1</td><td>LTE2</td><td>LTE3</td></tr>";
	print "<tr title=\"Link Status is the real end-to-end network connectivity status. Hence it is not real-time !\"><td align=left>Link Status</td>
			<td>$sdwan_link_status</td><td>$wan_link_status</td><td>$wan2_link_status</td><td>$wan3_link_status</td><td>-</td><td>$lte1_link_status</td><td>$lte2_link_status</td><td>$lte3_link_status</td></tr>";
	...
	print "<tr title=\"Latency is the real end-to-end network latency status polled periodically. Hence it is not real-time !\"><td align=left>Latency</td>
			<td>$sdwan_latency</td><td>$wan_latency</td><td>$wan2_latency</td><td>$wan3_latency</td><td>-</td><td>$lte1_latency</td><td>$lte2_latency</td><td>$lte3_latency</td></tr>";
	...
	print "<tr title=\"Jitter is the real end-to-end network jitter status (derived from latency) polled periodically. Hence it is not real-time !\"><td align=left>Jitter</td>
			<td>$sdwan_jitter</td><td>$wan_jitter</td><td>$wan2_jitter</td><td>$wan3_jitter</td><td>-</td><td>$lte1_jitter</td><td>$lte2_jitter</td><td>$lte3_jitter</td></tr>";
	...
	print "<tr title=\"Derived from port status last 24 hours. Hence it is not real-time !\"><td align=left>Link Up Count (past 24 hours)</td>
			<td>$link_status_sdwan_up_count</td><td>$link_status_wan_up_count</td><td>$link_status_wan2_up_count</td><td>$link_status_wan3_up_count</td><td>-</td><td>$link_status_lte1_up_count</td><td>$link_status_lte2_up_count</td><td>$link_status_lte3_up_count</td></tr>";
			
	print "<tr title=\"\"><td align=left>Last Link Up Timestamp</td>
			<td>$link_status_sdwan_up_count_timestamp</td><td>$link_status_wan_up_count_timestamp</td><td>$link_status_wan2_up_count_timestamp</td><td>$link_status_wan3_up_count_timestamp</td><td>-</td><td>$link_status_lte1_up_count_timestamp</td><td>$link_status_lte2_up_count_timestamp</td><td>$link_status_lte3_up_count_timestamp</td></tr>";
	...
	print "<tr title=\"Derived from port status last 24 hours. Hence it is not real-time !\"><td align=left>Link Down Count (past 24 hours)</td>
			<td>$link_status_sdwan_down_count</td><td>$link_status_wan_down_count</td><td>$link_status_wan2_down_count</td><td>$link_status_wan3_down_count</td><td>-</td><td>$link_status_lte1_down_count</td><td>$link_status_lte2_down_count</td><td>$link_status_lte3_down_count</td></tr>";
			
	print "<tr title=\"\"><td align=left>Last Link Down Timestamp</td>
			<td>$link_status_sdwan_down_count_timestamp</td><td>$link_status_wan_down_count_timestamp</td><td>$link_status_wan2_down_count_timestamp</td><td>$link_status_wan3_down_count_timestamp</td><td>-</td><td>$link_status_lte1_down_count_timestamp</td><td>$link_status_lte2_down_count_timestamp</td><td>$link_status_lte3_down_count_timestamp</td></tr>";
	...
	print "<td>"; get_stats_button($curr_page, "wan3", "wan3"); print "</td>";
	print "<td>-</td>";
	print "<td>"; get_stats_button($curr_page, "lte1", "lte1"); print "</td>";
	print "<td>"; get_stats_button($curr_page, "lte2", "lte2"); print "</td>";
	print "<td>"; get_stats_button($curr_page, "lte3", "lte3"); print "</td>";
	print "</tr>";
