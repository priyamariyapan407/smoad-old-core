<?php
	...
	print "<tr title=\"Derived from port status last 24 hours. Hence it is not real-time !\"><td align=left>Link Up Count (past 24 hours)</td>
			<td>$link_status_sdwan_up_count</td><td>-</td><td>-</td><td>-</td><td>$link_status_wan2_up_count</td><td>$link_status_wan_up_count</td><td>$link_status_lte1_up_count</td></tr>";
			
	print "<tr title=\"\"><td align=left>Last Link Up Timestamp</td>
			<td>$link_status_sdwan_up_count_timestamp</td><td>-</td><td>-</td><td>-</td><td>$link_status_wan2_up_count_timestamp</td><td>$link_status_wan_up_count_timestamp</td><td>$link_status_lte1_up_count_timestamp</td></tr>";
