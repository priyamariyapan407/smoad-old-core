<?php
	...
	$query = "select lan_cable_status, lan2_cable_status, wan_cable_status, wan2_cable_status, sdwan_cable_status,
	...
	print '<table class="list_items" style="width:660px;text-align:center;">';
	...
	print "<tr><td></td><td>LAN</td><td>SD-WAN</td><td>WAN2</td><td>WAN</td><td>LTE1</td><td>LTE2</td></tr>";
	print "<tr title=\"Link Status is the real end-to-end network connectivity status. Hence it is not real-time !\"><td align=left>Link Status</td>
			<td>-</td><td>$sdwan_link_status</td><td>$wan2_link_status</td><td>$wan_link_status</td><td>$lte1_link_status</td><td>$lte2_link_status</td></tr>";
	...
	print "<tr title=\"Latency is the real end-to-end network latency status polled periodically. Hence it is not real-time !\"><td align=left>Latency</td>
			<td>-</td><td>$sdwan_latency</td><td>$wan2_latency</td><td>$wan_latency</td><td>$lte1_latency</td><td>$lte2_latency</td></tr>";
	...
	print "<tr title=\"Jitter is the real end-to-end network jitter status (derived from latency) polled periodically. Hence it is not real-time !\"><td align=left>Jitter</td>
			<td>-</td><td>$sdwan_jitter</td><td>$wan2_jitter</td><td>$wan_jitter</td><td>$lte1_jitter</td><td>$lte2_jitter</td></tr>";
	...
	print "<tr title=\"Derived from port status last 24 hours. Hence it is not real-time !\"><td align=left>Link Up Count (past 24 hours)</td>
			<td>-</td><td>$link_status_sdwan_up_count</td><td>$link_status_wan2_up_count</td><td>$link_status_wan_up_count</td><td>$link_status_lte1_up_count</td><td>$link_status_lte2_up_count</td></tr>";
			
	print "<tr title=\"\"><td align=left>Last Link Up Timestamp</td>
			<td>-</td><td>$link_status_sdwan_up_count_timestamp</td><td>$link_status_wan2_up_count_timestamp</td><td>$link_status_wan_up_count_timestamp</td><td>$link_status_lte1_up_count_timestamp</td><td>$link_status_lte2_up_count_timestamp</td></tr>";
	...
	print "<tr title=\"Derived from port status last 24 hours. Hence it is not real-time !\"><td align=left>Link Down Count (past 24 hours)</td>
			<td>-</td><td>$link_status_sdwan_down_count</td><td>$link_status_wan2_down_count</td><td>$link_status_wan_down_count</td><td>$link_status_lte1_down_count</td><td>$link_status_lte2_down_count</td></tr>";
	
	print "<tr title=\"\"><td align=left>Last Link Down Timestamp</td>
			<td>-</td><td>$link_status_sdwan_down_count_timestamp</td><td>$link_status_wan2_down_count_timestamp</td><td>$link_status_wan_down_count_timestamp</td><td>$link_status_lte1_down_count_timestamp</td><td>$link_status_lte2_down_count_timestamp</td></tr>";
